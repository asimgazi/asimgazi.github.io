...
The key premise of my work is that healthcare interventions should not just be tailored to an individual's biobehavioral traits, genetics and other characteristics that differ from person to person but are constant over time. Healthcare interventions should be tailored to an individual's biobehavioral states -- psychophysiological stress and other features of a person that change over time. A quite remarkable (and challenging) aspect of health care delivery is that the same exact intervention can produce vastly different outcomes when delivered to the same individual in a different biobehavioral state. 
